...
class WriteController extends Controller
{
    ...
    public function acceptArticle(Article $articles)
    {
        ...
        return view('writer.dashboard', compact('message', 'Hai accettato l\'articolo scelto'));
    }
    ...
    public function rejectArticle(Article $articles)
    {
        ...
        return view('writer.dashboard', compact('message', 'Hai rifiutato l\'articolo scelto'));
    }
    ...
    public function undoArticle(Article $articles)
    {
        ...
        return view('writer.dashboard', compact('message', 'Hai riportato di nuovo l\'articolo scelto in revisione'));
    }
}
